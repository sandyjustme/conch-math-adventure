...
- [x] v3 真人测试 <2026-07-31>：她跳着看完 5 集、只对点单权兴奋，评价"幼稚/太简单/不够精彩"——短剧作为学习载体被证伪，降级为纯娱乐线
- [x] **v4 Step 0 上线 <2026-08-04>**：明牌工作制。班次「今天的活儿」为唯一入口与唯一钱源（3 张工单/天、完成制、固定工资、硬打烊）；elementaryDeps 路由首次落地（主干卡住自动补分数层）；起点=已解锁未过关且不低于 K5；隐形诊断（孩子界面零统计，家长看板见「她卡在哪」+首试时延）；游戏角重设计（深潜补氧/沉船翻牌，数值有策略意义、颜色不泄露答案）；设计见 `docs/superpowers/specs/2026-08-02-全局重构-架构设计.md`
- [ ] **Step 0 三天观察 <2026-08-04 起>**：①为换饭开工吗（≥2天做≥2张=过）②抱怨内容（"烦"=正常，"又在考我"=框架识破）③看板首试时延（>5s=在想，<3s且随机=在蒙）。通过→Step 1（心愿单凤冠/帮手机制）；失败→降 1 张/天再试一周，仍拒绝则工资框架证伪，回到产品外谈交易
